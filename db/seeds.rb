...
r.image.attach(io: File.open(path_image), filename: '1.jpeg')
...
r.image.attach(io: File.open(path_image), filename: '2.jpeg')
pc = ProductCategory.create!(title: 'Pratos Mexicanos', restaurant: r)
...
r.image.attach(io: File.open(path_image), filename: '3.jpeg')
...
r.image.attach(io: File.open(path_image), filename: '4.jpeg')
...
r.image.attach(io: File.open(path_image), filename: '5.jpeg')
...
r.image.attach(io: File.open(path_image), filename: '6.jpeg')
pc = ProductCategory.create!(title: 'Entrada', restaurant: r)
...
r.image.attach(io: File.open(path_image), filename: '7.jpeg')
...
r.image.attach(io: File.open(path_image), filename: '8.jpeg')
pc = ProductCategory.create!(title: 'Saladas, molhos e wraps', restaurant: r)
